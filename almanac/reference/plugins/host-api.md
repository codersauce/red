...
| `src/plugin/registry.rs` | Runtime compatibility gate; `RED_HOST_API_VERSION` is `0.8.0`, and `0.4.0`, `0.6.0`, and `0.7.0` remain accepted for existing packages [@registry]. |
